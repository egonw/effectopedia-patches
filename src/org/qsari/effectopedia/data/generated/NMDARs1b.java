...
public class NMDARs1b extends SourceGeneratedPathway
	{
		...
		public NMDARs1b(DataSource dataSource, boolean store)
			{
				super("Chronic binding of antagonist to N-methyl-D-aspartate receptors (NMDARs) during brain development induces impairment of learning and memory abilities",
						"N-methyl-D-aspartate receptors, NMDARs, brain development, learning imapriment,", dataSource,
						"D://Java//org.qsari.effectopedia//test//Chronic binding of antagonist to N-methyl-D-aspartate receptors (NMDARs) during brain development induces impairment of learning and memory abilities", store);
			}
		...
		protected Effect_DownstreamEffect									effect_downstreameffect4;
		...
		protected Link_EffectToEffect													link_effecttoeffect24;
		...
		public void genreateRevision1()
			{
				...
				effect_downstreameffect4.setTitle("NMDARs, Inhibition");
				...
				effect_downstreameffect4
						...
						.set(
								new DescriptionSection(
										...
										.setFormat(ContentFormat.HTML).<DescriptionSection> makeItLive(), 1);
				effect_downstreameffect4.getReferenceIDs().add(
						new Reference(effect_downstreameffect4, dataSource, "Barria A, Malinow R. (2002) Subunit-specific NMDA receptor trafficking to synapses. Neuron 35: 345-353.").<Reference> makeItLive());
				effect_downstreameffect4
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect4.getReferenceIDs().add(
						new Reference(effect_downstreameffect4, dataSource,
								"Cohen S, Greenberg ME. (2008) Communication between the synapse and the nucleus in neuronal development, plasticity, and disease. Ann Rev Cell Dev Biol 24: 183-209.")
								.<Reference> makeItLive());
				effect_downstreameffect4.getReferenceIDs().add(
						new Reference(effect_downstreameffect4, dataSource,
				...
				effect_downstreameffect4
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect4.getReferenceIDs().add(
						new Reference(effect_downstreameffect4, dataSource, "Lieberman DN, Mody I. (1999) Properties of single NMDA receptor channels in human dentate gyrus granule cells. J Physiol. 518: 55-70.")
								.<Reference> makeItLive());
				effect_downstreameffect4
						.getReferenceIDs()
						.add(
				...
				effect_downstreameffect5.setTitle("Calcium influx, Decreased");
				...
				effect_downstreameffect5.getReferenceIDs().add(
						new Reference(effect_downstreameffect5, dataSource, "Berridge MJ, Lipp P, Bootman MD. (2000) The versatility and universality of calcium signalling. Nat Rev Mol Cell Biol. 1:11-21.")
								.<Reference> makeItLive());
				effect_downstreameffect5.getReferenceIDs().add(
						new Reference(effect_downstreameffect5, dataSource, "Berridge MJ. (2012) Calcium signalling remodelling and disease. Biochem Soc Trans. 40: 297-309.").<Reference> makeItLive());
				effect_downstreameffect5
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect5.getReferenceIDs().add(
						new Reference(effect_downstreameffect5, dataSource, "Calvo M, Villalobos C, NÃºÃ±ez L. (2015) Calcium imaging in neuron cell death. Methods Mol Biol. 1254: 73-85.").<Reference> makeItLive());
				effect_downstreameffect5
						.getReferenceIDs()
						.add(
								new Reference(effect_downstreameffect5, dataSource,
				...
				effect_downstreameffect5
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect5.getReferenceIDs().add(new Reference(effect_downstreameffect5, dataSource, "Clapham DE. (2007) Calcium signaling. Cell 131: 1047-1058.").<Reference> makeItLive());
				effect_downstreameffect5.getReferenceIDs().add(
						new Reference(effect_downstreameffect5, dataSource, "Grienberger C, Konnerth A. (2012) Imaging calcium in neurons. Neuron 73: 862-885.").<Reference> makeItLive());
				effect_downstreameffect5.getReferenceIDs().add(
						new Reference(effect_downstreameffect5, dataSource, "Hagenston AM, Bading H. (2011) Calcium Signaling in Synapse-to-Nucleus Communication. Cold Spring Harb Perspect Biol. 3: a004564.")
								.<Reference> makeItLive());
				effect_downstreameffect5.getReferenceIDs().add(
						new Reference(effect_downstreameffect5, dataSource, "Higley MJ, Sabatini BL. (2012) Calcium signalling in dendritic spines. Cold Spring Harb Perspect Biol. 4: a005686.")
								.<Reference> makeItLive());
				effect_downstreameffect5.getReferenceIDs().add(
						new Reference(effect_downstreameffect5, dataSource, "Kettunen P. (2012) Calcium imaging in the zebrafish. Adv Exp Med Biol. 740: 1039-1071.").<Reference> makeItLive());
				effect_downstreameffect5.getReferenceIDs().add(
						new Reference(effect_downstreameffect5, dataSource, "Neher E., Sakaba T. (2008). Multiple roles of calcium ions in the regulation of neurotransmitter release. Neuron 59: 861-872.")
								.<Reference> makeItLive());
				effect_downstreameffect5
						.getReferenceIDs()
						.add(
				...
				effect_downstreameffect6.setTitle("Release of BDNF, Reduced");
				...
				effect_downstreameffect6
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect6.getReferenceIDs().add(
						new Reference(effect_downstreameffect6, dataSource, "Lessmann V, Gottmann K, Malcangio M. (2003) Neurotrophin secretion: current facts and future prospects. Prog Neurobiol. 69: 341-374. ")
								.<Reference> makeItLive());
				effect_downstreameffect6.getReferenceIDs().add(
						new Reference(effect_downstreameffect6, dataSource, "Lu B, Pang PT, Woo NH. (2005) The yin and yang of neurotrophin action. Nat Rev Neurosci. 6: 603-614. ").<Reference> makeItLive());
				effect_downstreameffect6.getReferenceIDs().add(
						new Reference(effect_downstreameffect6, dataSource,
				...
				effect_downstreameffect7.setTitle("Presynaptic release of glutamate, Reduced");
				...
				effect_downstreameffect7
						...
						.add(
								new Reference(
										...
										"Blanke ML, VanDongen AMJ. (2009) Activation Mechanisms of the NMDA Receptor. In: Van Dongen AM, editor. Biology of the NMDA Receptor. Boca Raton (FL): CRC Press; Chapter 13. Available from: http://www.ncbi.nlm.nih.gov/books/NBK5274/ ")
										.<Reference> makeItLive());
				effect_downstreameffect7.getReferenceIDs().add(
						new Reference(effect_downstreameffect7, dataSource, "Cleland TA. (1996) Inhibitory glutamate receptor channels. Mol Neurobiol. 13: 97-136. ").<Reference> makeItLive());
				effect_downstreameffect7
						.getReferenceIDs()
						.add(
								new Reference(effect_downstreameffect7, dataSource,
										...
										.<Reference> makeItLive());
				effect_downstreameffect7.getReferenceIDs().add(
						new Reference(effect_downstreameffect7, dataSource, "Mattson MP. (2008) Glutamate and neurotrophic factors in neuronal plasticity and disease. Ann N Y Acad Sci. 1144: 97-112. ")
								.<Reference> makeItLive());
				effect_downstreameffect7.getReferenceIDs().add(
						new Reference(effect_downstreameffect7, dataSource, "Meldrum BS. (2000) Glutamate as a neurotransmitter in the brain: review of physiology and pathology. J Nutr. 130: 1007S-1015S. ")
								.<Reference> makeItLive());
				effect_downstreameffect7.getReferenceIDs().add(
						new Reference(effect_downstreameffect7, dataSource, "Nedergaard M, Takano T, Hansen AJ. (2002) Beyond the role of glutamate as a neurotransmitter. Nat Rev Neurosci. 3: 748-755. ")
								.<Reference> makeItLive());
				effect_downstreameffect7.getReferenceIDs().add(
						new Reference(effect_downstreameffect7, dataSource, "Platt SR. (2007) The role of glutamate in central nervous system health and disease-a review. Vet J. 173: 278-286. ")
								.<Reference> makeItLive());
				effect_downstreameffect7
						.getReferenceIDs()
						.add(
				...
				effect_downstreameffect8.setTitle("Cell death, N/A");
				...
				effect_downstreameffect8.getReferenceIDs()
						.add(
								new Reference(effect_downstreameffect8, dataSource,
										...
										.<Reference> makeItLive());
				effect_downstreameffect8.getReferenceIDs().add(
						new Reference(effect_downstreameffect8, dataSource, "Fujikawa, D.G. (2015), The role of excitotoxic programmed necrosis in acute brain injury. Comput Struct Biotechnol J. 13: 212-221. ")
								.<Reference> makeItLive());
				effect_downstreameffect8.getReferenceIDs().add(
						new Reference(effect_downstreameffect8, dataSource,
				...
				effect_downstreameffect8
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect8.getReferenceIDs().add(
						new Reference(effect_downstreameffect8, dataSource, "Li, P. et al. (2004), Mitochondrial activation of apoptosis. Cell 116: S57-59. ").<Reference> makeItLive());
				effect_downstreameffect8.getReferenceIDs().add(
						new Reference(effect_downstreameffect8, dataSource, "Loo, D.T. (2002), TUNEL Assay an overview of techniques. Methods in Molecular Biology, vol. 203: In ").<Reference> makeItLive());
				effect_downstreameffect8.getReferenceIDs().add(
						new Reference(effect_downstreameffect8, dataSource, "Situ Detection of DNA Damage, chapter 2, Didenko VV (ed.), Humana Press Inc. ").<Reference> makeItLive());
				effect_downstreameffect8.getReferenceIDs().add(
						new Reference(effect_downstreameffect8, dataSource, "Malhi, H. et al. (2010), Hepatocyte death: a clear and present danger. Physiol Rev. 90: 1165-1194. ").<Reference> makeItLive());
				effect_downstreameffect8.getReferenceIDs().add(
						new Reference(effect_downstreameffect8, dataSource, "Moore, A. et al. (1998), Simultaneous measurement of cell cycle and apoptotic cell death. Methods Cell Biol. 57: 265-278.  ")
								.<Reference> makeItLive());
				
				effect_downstreameffect9 = new Effect_DownstreamEffect(pathway, dataSource);
				effect_downstreameffect9.setTitle("Dendritic morphology, Aberrant");
				...
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource, "Dailey ME, Smith SJ. (1996) The dynamics of dendritic structure in developing hippocampal slices. J Neurosci. 16: 2983-2994. ")
								.<Reference> makeItLive());
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource,
				...
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource, "Grueber WB, Jan LY, Jan YN. (2002) Tiling of the Drosophila epidermis by multidendritic sensory neurons. Development 129: 2867-2878. ")
								.<Reference> makeItLive());
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource, "Harrill JA, Mundy WR. (2011) Quantitative assessment of neurite outgrowth in PC12 cells. Methods Mol Biol. 758: 331-348. ")
								.<Reference> makeItLive());
				effect_downstreameffect9
						.getReferenceIDs()
						.add(
				...
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource,
								...
								.<Reference> makeItLive());
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource, "Redmond L. (2008) Translating neuronal activity into dendrite elaboration: signaling to the nucleus. Neurosignals 16: 194-208. ")
								.<Reference> makeItLive());
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource, "Rubel EW, Fritzsch B. (2002) Auditory system development: primary auditory neurons and their targets. Annu Rev Neurosci. 25: 51-101. ")
								.<Reference> makeItLive());
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource, "Scott EK, Luo L: (2001) How do dendrites take their shape? Nat Neurosci. 4: 359-365. ").<Reference> makeItLive());
				effect_downstreameffect9.getReferenceIDs().add(
						new Reference(effect_downstreameffect9, dataSource, "SjÃ¶strÃ¶m PJ, Rancz EA, Roth A, HÃ¤usser M. (2008) Dendritic excitability and synaptic plasticity. Physiol Rev. 88: 769-840. ")
								.<Reference> makeItLive());
				effect_downstreameffect9
						.getReferenceIDs()
						.add(
				...
				effect_downstreameffect10.setTitle("Synaptogenesis, Decreased");
				...
				effect_downstreameffect10.getReferenceIDs().add(
						new Reference(effect_downstreameffect10, dataSource, "ColÃ³n -Ramos DA. (2009) Synapse formation in developing neural circuits. Curr Top Devel Biol. 87: 53-79. ").<Reference> makeItLive());
				effect_downstreameffect10.getReferenceIDs().add(
						new Reference(effect_downstreameffect10, dataSource,
				...
				effect_downstreameffect10.getReferenceIDs().add(
						new Reference(effect_downstreameffect10, dataSource, "Erecinska M, Cherian S, Silver IA. (2004) Energy metabolism in mammalian brain during development. Prog Neurobiol. 73: 397-445. ")
								.<Reference> makeItLive());
				effect_downstreameffect10
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect10.getReferenceIDs().add(
						new Reference(effect_downstreameffect10, dataSource, "Garner CC, Zhai RC, Gundelfinger ED, Ziv NE. (2002) Molecular mechanisms of CNS synaptogenesis. Cell Press 25: 243-250. ")
								.<Reference> makeItLive());
				effect_downstreameffect10.getReferenceIDs().add(
						new Reference(effect_downstreameffect10, dataSource,
				...
				effect_downstreameffect10.getReferenceIDs().add(
						new Reference(effect_downstreameffect10, dataSource,
								...
								.<Reference> makeItLive());
				effect_downstreameffect10.getReferenceIDs().add(
						new Reference(effect_downstreameffect10, dataSource, "Munno DW, Syed NI. (2003) Synaptogenesis in the CNS: an odyssey from wiring together to firing together. J Physiol. 552: 1-11. ")
								.<Reference> makeItLive());
				effect_downstreameffect10
						.getReferenceIDs()
						.add(
				...
				effect_downstreameffect10.getReferenceIDs().add(
						new Reference(effect_downstreameffect10, dataSource, "Tau GZ, Peterson BS. (2010) Normal Development of Brain Circuits. Neuropsychopharmacology 35: 147-168. ").<Reference> makeItLive());
				
				effect_downstreameffect11 = new Effect_DownstreamEffect(pathway, dataSource);
				effect_downstreameffect11.setTitle("Neuronal network function, Decreased");
				...
				effect_downstreameffect11.getReferenceIDs().add(
						new Reference(effect_downstreameffect11, dataSource,
				...
				effect_downstreameffect11.getReferenceIDs().add(
						new Reference(effect_downstreameffect11, dataSource, "Erecinska M, Cherian S, Silver IA. (2004) Energy metabolism in mammalian brain during development. Prog Neurobiol. 73: 397-445. ")
								.<Reference> makeItLive());
				effect_downstreameffect11.getReferenceIDs().add(
						new Reference(effect_downstreameffect11, dataSource,
				...
				effect_downstreameffect11.getReferenceIDs().add(
						new Reference(effect_downstreameffect11, dataSource, "Mayford M, Siegelbaum SA, Kandel ER. (2012) Synapses and memory storage. Cold Spring Harb Perspect Biol. 4. pii: a005751. ")
								.<Reference> makeItLive());
				effect_downstreameffect11
						.getReferenceIDs()
						.add(
				...
				effect_downstreameffect11
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect11.getReferenceIDs().add(
						new Reference(effect_downstreameffect11, dataSource, "Yuste R, Peinado A, Katz LC. (1992) Neuronal domains in developing neocortex. Science 257: 665-669. ").<Reference> makeItLive());
				
				effect_downstreameffect12 = new Effect_DownstreamEffect(pathway, dataSource);
				effect_downstreameffect12.setTitle("Learning and memory, Impairment");
				...
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Abbott LF, Nelson SB. (2000) Synaptic plasticity: Taming the beast. Nat Neurosci 3: 1178â€“1183. ").<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Abraham HAJ, Bear MF. Bidirectional modification of CA1 synapses in the adult hippocampus in vivo. Nature. 1996 May 9;381(6578):163-6. ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Aggleton JP, Brown MW. (1999) Episodic memory, amnesia, and the hippocampal-anterior thalamic axis. Behav Brain Sci. 22: 425-489. ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Arshavsky YI. 2010. Why Alzheimer's disease starts with a memory impairment: neurophysiological insight. J Alzheimers Dis 20(1): 5-16. ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Barker GR, Warburton EC. (2011) When is the hippocampus involved in recognition memory? J Neurosci. 31: 10721-10731. ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Burns A, Iliffe, S. (2009). Dementia. BMJ (Clinical research ed.) 338: b75. ").<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
				...
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource,
								...
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Doya K. (2000) Complementary roles of basal ganglia and cerebellum in learning and motor control. Curr Opin Neurobiol. 10: 732-739. ")
								.<Reference> makeItLive());
				effect_downstreameffect12
						.getReferenceIDs()
						.add(
				...
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Lynch MA. (2004) Long-term potentiation and memory. Physiol Rev. 84: 87-136. ").<Reference> makeItLive());
				effect_downstreameffect12
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Malenka RC, Bear MF (2004). LTP and LTD: An embarrassment of riches. Neuron 44: 5â€“21. ").<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs()
						.add(
								new Reference(effect_downstreameffect12, dataSource,
				...
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource,
								...
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Mullally SL, Maguire EA. (2014) Learning to remember: the early ontogeny of episodic memory. Dev Cogn Neurosci. 9: 12-29. ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "OECD (2004) Series on testing and assessment number 20, Guidance document for neurotoxicity testing. ").<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource,
								...
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "OECD (2008) Nr 43 GUIDANCE DOCUMENT ON MAMMALIAN REPRODUCTIVE TOXICITY TESTING AND ASSESSMENT. ENV/JM/MONO(2008)16 ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource,
								...
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Quirk GJ, Mueller D. (2008) Neural mechanisms of extinction learning and retrieval. Neuropsychopharmacology 33: 56-72. ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs()
						.add(
								new Reference(effect_downstreameffect12, dataSource, "Roberts AC, Bill BR, Glanzman DL. (2013) Learning and memory in zebrafish larvae. Front Neural Circuits 7: 126. ")
										.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource,
				...
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Solomon, Andrew E. Budson, Paul R. (2011). Memory loss : a practical guide for clinicians. Elsevier Saunders. ISBN 9781416035978 ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Stellwagen D, Malenka RC. (2006) Synaptic scaling mediated by glial TNF-Î±. Nature 440: 1054â€“1059. ").<Reference> makeItLive());
				effect_downstreameffect12
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource, "Toscano CD, Guilarte TR. (2005) Lead neurotoxicity: From exposure to molecular effects. Brain Res Rev. 49: 529-554. ")
								.<Reference> makeItLive());
				effect_downstreameffect12.getReferenceIDs().add(
						new Reference(effect_downstreameffect12, dataSource,
				...
				link_chemstructtomie13 = new Link_ChemStructToMIE(pathway, dataSource, initiator_chemicalstructure1, effect_molecularinitiatingevent3);
				link_chemstructtomie13.setLinkType(LinkType.UNKNOWN);
				link_effecttoeffect15 = new Link_EffectToEffect(pathway, dataSource, effect_molecularinitiatingevent3, effect_downstreameffect4);
				link_effecttoeffect15.setLinkType(LinkType.DIRECT);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect15_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect15, dataSource, Link_EffectToEffect.class, 3.0);
				link_effecttoeffect15
						...
						.set(
								new DescriptionSection_Structured(
										...
										link_effecttoeffect15_weigth1).setFormat(ContentFormat.HTML).<DescriptionSection_Structured> makeItLive(), 1);
				link_effecttoeffect15
						.getDescriptionIDs()
						.set(
								new DescriptionSection(
				...
				link_effecttoeffect16 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect4, effect_downstreameffect5);
				...
				link_effecttoeffect16
						...
						.set(
								new DescriptionSection_Structured(
										...
										link_effecttoeffect16_weigth1).setFormat(ContentFormat.HTML).<DescriptionSection_Structured> makeItLive(), 1);
				link_effecttoeffect16
						.getDescriptionIDs()
						.set(
								new DescriptionSection(
										...
										.setFormat(ContentFormat.HTML).<DescriptionSection> makeItLive(), 2);
				link_effecttoeffect16.getReferenceIDs().add(new Reference(link_effecttoeffect16, dataSource, "Berridge MJ. (1998) Neuronal calcium signaling. Neuron 21: 13-26.").<Reference> makeItLive());
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource, "Bressler JP, Goldstein GW. (1991) Mechanisms of lead neurotoxicity. Biochem Pharmacol. 41: 479-484.").<Reference> makeItLive());
				link_effecttoeffect16
						.getReferenceIDs()
						.add(
								new Reference(
				...
				link_effecttoeffect16
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource, "Felix R. (2005) Molecular regulation of voltage-gated Ca2+ channels. J Recept Signal Transduct Res. 25: 57-71.").<Reference> makeItLive());
				link_effecttoeffect16
						.getReferenceIDs()
						.add(
								new Reference(
				...
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource,
								...
								.<Reference> makeItLive());
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource, "Higley MJ, Sabatini BL. (2012) Calcium signalling in dendritic spines. Cold Spring Harb Perspect Biol 4: a005686.").<Reference> makeItLive());
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource,
				...
				link_effecttoeffect16
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource, "Perez-Reyes E, Schneider T. (1994) Calcium channels: Structure, function, and classification. Drug Dev Res. 33: 295â€“318.")
								.<Reference> makeItLive());
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource, "Sandhir R, Gill KD. (1994) Alterations in calcium homeostasis on lead exposure in rat synaptosomes. Mol Cell Biochem. 131: 25-33.")
								.<Reference> makeItLive());
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource,
				...
				link_effecttoeffect16
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect16.getReferenceIDs().add(
						new Reference(link_effecttoeffect16, dataSource, "Toscano CD, Guilarte TR. (2005) Lead neurotoxicity: From exposure to molecular effects. Brain Res Rev. 49: 529-555.").<Reference> makeItLive());
				link_effecttoeffect16
						.getReferenceIDs()
						.add(
								new Reference(
				...
				link_effecttoeffect17 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect5, effect_downstreameffect6);
				...
				link_effecttoeffect17.getReferenceIDs().add(
						new Reference(link_effecttoeffect17, dataSource,
								"Schneider JS, Mettil W, Anderson DW. (2012). Differential Effect of Postnatal Lead Exposure on Gene Expression in the Hippocampus and Frontal Cortex. J Mol Neurosci. 47: 76-88. ")
								.<Reference> makeItLive());
				link_effecttoeffect17.getReferenceIDs()
						.add(
								new Reference(link_effecttoeffect17, dataSource,
				...
				link_effecttoeffect18 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect6, effect_downstreameffect7);
				link_effecttoeffect18.setLinkType(LinkType.UNKNOWN);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect18_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect18, dataSource, Link_EffectToEffect.class, 1.0);
				link_effecttoeffect18
						.getDescriptionIDs()
						.set(
								new DescriptionSection_Structured(
										link_effecttoeffect18,
				...
				link_effecttoeffect18
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect18.getReferenceIDs().add(
						new Reference(link_effecttoeffect18, dataSource,
				...
				link_effecttoeffect18.getReferenceIDs().add(
						new Reference(link_effecttoeffect18, dataSource, "Minichiello L. (2009) TrkB signalling pathways in LTP and learning. Nat Rev Neurosci. 10: 850-860. ").<Reference> makeItLive());
				link_effecttoeffect18
						.getReferenceIDs()
						.add(
								new Reference(
				...
				link_effecttoeffect19 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect6, effect_downstreameffect8);
				link_effecttoeffect19.setLinkType(LinkType.UNKNOWN);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect19_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect19, dataSource, Link_EffectToEffect.class, 1.0);
				...
				link_effecttoeffect19.getReferenceIDs().add(
						new Reference(link_effecttoeffect19, dataSource, "Bernd P. (2008) The role of neurotrophins during early development. Gene Expr. 14: 241-250. ").<Reference> makeItLive());
				link_effecttoeffect19
						.getReferenceIDs()
						.add(
				...
				link_effecttoeffect19.getReferenceIDs().add(
						new Reference(link_effecttoeffect19, dataSource, "Farber NB, Creeley CE, Olney JW. (2010) Alcohol-induced neuroapoptosis in the fetal macaque brain. Neurobiol Dis. 40:200-206. ")
								.<Reference> makeItLive());
				link_effecttoeffect19.getReferenceIDs().add(
						new Reference(link_effecttoeffect19, dataSource,
				...
				link_effecttoeffect19
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect19.getReferenceIDs().add(
						new Reference(link_effecttoeffect19, dataSource, "Henderson CE. (1996). Programmed cell death in the developing nervous system. Neuron 17: 579-585. ").<Reference> makeItLive());
				link_effecttoeffect19
						.getReferenceIDs()
						.add(
								new Reference(
				...
				link_effecttoeffect19
						...
						.add(
								new Reference(link_effecttoeffect19, dataSource,
										...
										.<Reference> makeItLive());
				link_effecttoeffect19.getReferenceIDs().add(
						new Reference(link_effecttoeffect19, dataSource, "Lee R, Kermani P, Teng KK, Hempstead BL. (2001) Regulation of cell survival by secreted proneurotrophins. Science 294: 1945-1948. ")
								.<Reference> makeItLive());
				link_effecttoeffect19
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect19.getReferenceIDs().add(
						new Reference(link_effecttoeffect19, dataSource, "Miller FD, Kaplan DR. (2001) Neurotrophin signalling pathways regulating neuronal apoptosis. Cell Mol Life Sci. 58: 1045-1053. ")
								.<Reference> makeItLive());
				link_effecttoeffect19
						.getReferenceIDs()
						.add(
				...
				link_effecttoeffect19
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect19.getReferenceIDs()
						.add(
								new Reference(link_effecttoeffect19, dataSource,
				...
				link_effecttoeffect20 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect6, effect_downstreameffect9);
				link_effecttoeffect20.setLinkType(LinkType.UNKNOWN);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect20_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect20, dataSource, Link_EffectToEffect.class, 1.0);
				...
				link_effecttoeffect20
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect20.getReferenceIDs().add(
						new Reference(link_effecttoeffect20, dataSource, "Jan YN, Jan LY (2010). Branching out: mechanisms of dendritic arborization. Nat Rev Neurosci. 11: 316-328. ").<Reference> makeItLive());
				link_effecttoeffect20.getReferenceIDs().add(
						new Reference(link_effecttoeffect20, dataSource,
				...
				link_effecttoeffect20
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect20.getReferenceIDs().add(
						new Reference(link_effecttoeffect20, dataSource, "McAllister AK, Lo DC, Katz LC. (1995) Neurotrophins regulate dendritic growth in developing visual cortex. Neuron 15: 791-803. ")
								.<Reference> makeItLive());
				link_effecttoeffect20.getReferenceIDs().add(
						new Reference(link_effecttoeffect20, dataSource, "McAllister AK, Katz LC, Lo DC. (1996) Neurotrophin regulation of cortical dendritic growth requires activity. Neuron 17: 1057-1064. ")
								.<Reference> makeItLive());
				link_effecttoeffect20
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect20.getReferenceIDs().add(
						new Reference(link_effecttoeffect20, dataSource, "Park H, Poo MM. (2013) Neurotrophin regulation of neural circuit development and function. Nat Rev Neurosci 14: 7-23. ")
								.<Reference> makeItLive());
				link_effecttoeffect20.getReferenceIDs().add(
						new Reference(link_effecttoeffect20, dataSource,
				...
				link_effecttoeffect21 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect7, effect_downstreameffect10);
				link_effecttoeffect21.setLinkType(LinkType.UNKNOWN);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect21_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect21, dataSource, Link_EffectToEffect.class, 1.0);
				link_effecttoeffect21
						...
						.set(
								new DescriptionSection_Structured(
										...
										link_effecttoeffect21_weigth1).setFormat(ContentFormat.TEXT).<DescriptionSection_Structured> makeItLive(), 1);
				...
				link_effecttoeffect22 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect8, effect_downstreameffect10);
				link_effecttoeffect22.setLinkType(LinkType.UNKNOWN);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect22_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect22, dataSource, Link_EffectToEffect.class, 1.0);
				link_effecttoeffect22
						.getDescriptionIDs()
						.set(
								new DescriptionSection_Structured(
										link_effecttoeffect22,
				...
				link_effecttoeffect22.getReferenceIDs().add(
						new Reference(link_effecttoeffect22, dataSource, "Buss RR, Sun W, Oppenheim RW. (2006) Adaptive roles of programmed cell death during nervous system development. Annu Rev Neurosci. 29: 1-35. ")
								.<Reference> makeItLive());
				link_effecttoeffect22
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect22.getReferenceIDs().add(
						new Reference(link_effecttoeffect22, dataSource,
				...
				link_effecttoeffect22.getReferenceIDs().add(
						new Reference(link_effecttoeffect22, dataSource, "Innocenti, GM, Price DJ. (2005) Exuberance in the development of cortical networks. Nat Rev Neurosci. 6: 955-965. ").<Reference> makeItLive());
				link_effecttoeffect22
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect22.getReferenceIDs().add(
						new Reference(link_effecttoeffect22, dataSource, "Mennerick S, Zorumski CF. (2000) Neural activity and survival in the developing nervous system. Mol Neurobiol. 22: 41-54. ")
								.<Reference> makeItLive());
				link_effecttoeffect22
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect22.getReferenceIDs().add(
						new Reference(link_effecttoeffect22, dataSource, "Olney JW. (2014) Focus on apoptosis to decipher how alcohol and many other drugs disrupt brain development front. Pediatr. 2: 81. ")
								.<Reference> makeItLive());
				link_effecttoeffect22.getReferenceIDs().add(
						new Reference(link_effecttoeffect22, dataSource, "Oppenheim RW. (1991). Cell death during development of the nervous system. Annu Rev Neurosci. 14: 453-501. ").<Reference> makeItLive());
				link_effecttoeffect22
						.getReferenceIDs()
						.add(
								new Reference(
				...
				link_effecttoeffect23 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect9, effect_downstreameffect10);
				link_effecttoeffect23.setLinkType(LinkType.UNKNOWN);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect23_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect23, dataSource, Link_EffectToEffect.class, 1.0);
				link_effecttoeffect23
						...
						.set(
								new DescriptionSection_Structured(
										...
										link_effecttoeffect23_weigth1).setFormat(ContentFormat.TEXT).<DescriptionSection_Structured> makeItLive(), 1);
				link_effecttoeffect23.getReferenceIDs().add(
						new Reference(link_effecttoeffect23, dataSource, "Bhatt DH, Zhang S, Gan WB. (2009). Dendritic Spine Dynamics. Ann Rev Physiol. 71: 261-282. ").<Reference> makeItLive());
				link_effecttoeffect23.getReferenceIDs().add(
				...
				link_effecttoeffect23.getReferenceIDs().add(
						new Reference(link_effecttoeffect23, dataSource, "McAllister AK. (2007) Dynamic aspects of CNS synapse formation. Ann Rev of Neurosc. 30: 425-450. ").<Reference> makeItLive());
				link_effecttoeffect23
						.getReferenceIDs()
						.add(
								new Reference(
				...
				link_effecttoeffect23.getReferenceIDs().add(
						new Reference(link_effecttoeffect23, dataSource, "SjÃ¶strÃ¶m PJ, Rancz EA, Roth A, HÃ¤usser M. (2008) Dendritic excitability and synaptic plasticity. Physiol Rev. 88: 769-840. ")
								.<Reference> makeItLive());
				link_effecttoeffect23
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				link_effecttoeffect23.getReferenceIDs().add(
						new Reference(link_effecttoeffect23, dataSource, "Zhang W, Benson DL. (2001) Stages of synapse development defined by dependence on F-actin. J Neurosci. 21: 5169-5181. ")
								.<Reference> makeItLive());
				link_effecttoeffect23.getReferenceIDs().add(
						new Reference(link_effecttoeffect23, dataSource,
				...
				link_effecttoeffect24 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect10, effect_downstreameffect11);
				link_effecttoeffect24.setLinkType(LinkType.UNKNOWN);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect24_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect24, dataSource, Link_EffectToEffect.class, 1.0);
				link_effecttoeffect24
						.getDescriptionIDs()
						.set(
								new DescriptionSection_Structured(
										link_effecttoeffect24,
										...
										link_effecttoeffect24_weigth1).setFormat(ContentFormat.TEXT).<DescriptionSection_Structured> makeItLive(), 1);
				link_effecttoeffect24.getReferenceIDs().add(
						new Reference(link_effecttoeffect24, dataSource,
								...
								.<Reference> makeItLive());
				link_effecttoeffect24.getReferenceIDs().add(
						new Reference(link_effecttoeffect24, dataSource, "ColÃ³n-Ramos DA. (2009) Synapse formation in developing neural circuits. Curr Top Dev Biol. 87: 53-79. ").<Reference> makeItLive());
				link_effecttoeffect24.getReferenceIDs().add(
						new Reference(link_effecttoeffect24, dataSource,
				...
				link_effecttoeffect24
						...
						.add(
								new Reference(link_effecttoeffect24, dataSource,
										...
										.<Reference> makeItLive());
				link_effecttoeffect24.getReferenceIDs().add(
						new Reference(link_effecttoeffect24, dataSource, "Rodier PM. (1995) Developing brain as a target of toxicity. Environ. Health Perspect. 103: 73-76.").<Reference> makeItLive());
				
				link_effecttoeffect25 = new Link_EffectToEffect(pathway, dataSource, effect_downstreameffect11, effect_downstreameffect12);
				link_effecttoeffect25.setLinkType(LinkType.UNKNOWN);
				ReferenceIDW<Link_EffectToEffect> link_effecttoeffect25_weigth1 = new ReferenceIDW<Link_EffectToEffect>(link_effecttoeffect25, dataSource, Link_EffectToEffect.class, 1.0);
				link_effecttoeffect25
						...
						.set(
								new DescriptionSection_Structured(
										...
										link_effecttoeffect25_weigth1).setFormat(ContentFormat.TEXT).<DescriptionSection_Structured> makeItLive(), 1);
				...
				pathway.getUids().parseString("OECD Project No:1.23");
				pathway.getStatus().parseString("TFHA/WNT Endorsed");
				...
				pathway
						...
						.set(
								new DescriptionSection(
										...
										"<i>Provide an overall discussion of the quantitative information available for this AOP. Support calls for the individual relationships can be included in the Key Event Relationship table above.</i><br><br>\n\nA quantitative structure activity relationship (QSAR) model has been developed based on various molecular parameters that have been calculated for a series of competitive NMDA antagonists with known activity values and these parameters have been applied to make a regression analysis which provides a model that relates the computationally calculated parameters to experimentally determined activity values (Korkut and Varnali, 2003).<br><br>\n\nRecently, a QSAR model for non- competitive antagonists of NMDA receptor based on a series of 48 substituted MK-801 derivatives has been established (Chtitaa et al., 2015). In this paper, a quantitative model has been proposed and there has also been an attempt to interpret the activity of the compounds relying on the multivariate statistical analyses. By this approach, they have been able to predict the inhibitory activity of a set of new designed compounds (Chtitaa et al., 2015).<br><br>\n\n2D- and 3D-QSAR models have also been developed to establish the structural requirements for pyrazine and related derivatives for being NR2B selective NMDA receptor antagonists (Zambre et al., 2015).\n\n")
				...
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								...
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Bai X, Twaroski D, Bosnjak ZJ. (2013) Modeling anesthetic developmental neurotoxicity using human stem cells. Semin Cardiothorac Vasc Anesth. 17: 276-287.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Bear MF. (1996) A synaptic basis for memory storage in the cerebral cortex. Proc Natl Acad Sci USA 93: 13453-13459.").<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
				...
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								...
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Colon-Ramos DA. (2009) Synapse formation in developing neural circuits. Current topics in developmental biology 87: 53-79.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								"Cline H, Haas K. (2008) The regulation of dendritic arbor development and plasticity by glutamatergic synaptic input: a review of the synaptotrophic hypothesis. J Physiol 586: 1509-1517.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs()
						.add(
								new Reference(pathway, dataSource,
										"Creeley CE, Olney JW. (2013) Drug-Induced Apoptosis: Mechanism by which Alcohol and Many Other Drugs can Disrupt Brain Development. Brain Sci. 3: 1153–1181.").<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Erecinska M, Cherian S, Silver IA. (2004) Energy metabolism in mammalian brain during development. Prog Neurobiol. 73: 397-445.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								"Espinosa JS, Wheeler DG, Tsien RW, Luo L. (2009) Uncoupling dendrite growth and patterning: single-cell knockout analysis of NMDA receptor 2B. Neuron 62:205–217.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Fredriksson A, Archer T. (2004) Neurobehavioural deficits associated with apoptotic neurodegeneration and vulnerability for ADHD. Neurotox Res. 6: 435–456.")
								.<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Fu M, Yu X, Lu J, Zuo Y. (2012) Repetitive motor learning induces coordinated formation of clustered dendritic spines in vivo. Nature 483: 92-95.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Granger AJ, Gray JA, Lu W, Nicol RA. (2011) Genetic analysis of neuronal ionotropic glutamate receptors subunits. J Physiol. 589: 4095–4101.")
								.<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Guilarte TR. (1997) Glutamatergic system and developmental lead neurotoxicity. Neurotoxicology 18, 665–672.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								"Guilarte TR, McGlothan, JL. (1998) Hippocampal NMDA receptor mRNA undergoes subunit-specific changes during developmental lead exposure. Brain Res. 790, 98–107.").<Reference> makeItLive());
				pathway
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Holtmaat A, Svoboda K. (2009) Experience-dependent structural synaptic plasticity in the mammalian brain. Nat Rev Neurosci. 10: 647-658.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								"Hwang JY, Kim YH, Ahn YH, Wie MB, Koh JY. (1999) N-Methyl-D-aspartate receptor blockade induces neuronal apoptosis in cortical culture. Exp Neurol. 159: 124-130.").<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
				...
				pathway
						...
						.add(
								new Reference(pathway, dataSource,
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Johnston MV, Ishida A, Ishida WN, Matsushita HB, Nishimura A, Tsuji M. (2009) Plasticity and injury in the developing brain. Brain Dev. 31:1-10.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Kang H, Schuman EM. (1996) A requirement for local protein synthesis in neurotrophin-induced hippocampal synaptic plasticity. Science 273:1402–1406.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Klintsova AY, Greenough WT. (1999) Synaptic plasticity in cortical systems. Curr Opin Neurobiol. 9: 203-208.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								"Korkut A, Varnali T. (2003) Quantitative structure activity relationship (QSAR) of competitive N-methyl-D-aspartate (NMDA) antagonists. Mol Phys 101: 3285-3291.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Kovalchuk Y, Holthoff K, and Konnerth A. (2004) Neurotrophin action on a rapid timescale. Curr Opin Neurobiol 14:558–563.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Kumari M, Ticku MK. (1998). Ethanol and regulation of the NMDA receptor subunits in fetal cortical neuron. J Neurochem: 70, 1467–1473.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								...
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Lu Y, Christian K, Lu B. (2008) BDNF: a key regulator for protein synthesis dependent LTP and long-term memory? Neurobiol Learn Mem. 89: 312–323.")
								.<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Manabe T. (2009) LTP. Encyclopedia of neuroscience. M D. Binder, N. Hirokawa and U. Windhorst (Eds). Springer-Verlag GmbH Berlin Heidelberg. pp 2188-2190")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Mattson MP. (2008) Glutamate and neurotrophic factors in neuronal plasticity and disease. Ann N Y Acad Sci. 1144: 97-112.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "McAllister AK, Katz LC, Lo DC. (1996) Neurotrophin regulation of cortical dendritic growth requires activity. Neuron 17: 1057.").<Reference> makeItLive());
				pathway.getReferenceIDs()
						.add(new Reference(pathway, dataSource, "McAllistair AK. (2000) Cellular and molecular mechanisms of dendrite growth. Cereb Cortex 10: 963-973.").<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
				...
				pathway
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Nagappan G, Lu B. (2005) Activity-dependent modulation of the BDNF receptor TrkB: mechanisms and implications. Trends Neurosci. 28: 464-471.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "OECD (1996) Guideline 422 on Combined Repeated Dose Toxicity Study with the Reproduction/Developmental Toxicity Screening Test.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(new Reference(pathway, dataSource, "OECD (2007) Guideline 426 on Developmental Neurotoxicity.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(new Reference(pathway, dataSource, "OECD (2011) Guideline 443 on Extended One-Generation Reproductive Toxicity Study.").<Reference> makeItLive());
				...
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Ogura H, Aigner TG. (1993) MK-801 impairs recognition memory in rhesus monkeys: comparison with cholinergic drugs. J Pharmacol Exp Ther. 266: 60-64.")
								.<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(new Reference(pathway, dataSource, "Poo MM. (2001) Neurotrophins as synaptic modulators. Nat Rev Neurosci. 2: 24–32.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Purpura DP. (1975) Dendritic differentiation in human cerebral cortex: normal and aberrant developmental patterns. Adv Neurol. 12: 91–134.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								...
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Rajan I, Cline HT. (1998) Glutamate receptor activity is required for normal development of tectal cell dendrites in vivo. J Neurosci. 18: 7836.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
				...
				pathway
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Riedel G, Platt B, Micheau J. (2003) Glutamate receptor function in learning and memory. Behav Brain Res. 140: 1-47.").<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
				...
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								"Roberts TF, Tschida KA, Klein ME, Mooney R. (2010) Rapid spine stabilization and synaptic enhancement at the onset of behavioural learning. Nature 463: 948-952.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
				...
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								...
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Sekino Y, Kojima N, Shirao T. (2007) Role of actin cytoskeleton in dendritic spine morphogenesis. Neurochem Int. 51: 92-104.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
				...
				pathway
						...
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Silva AJ, Paylor R, Wehner JM, Tonegawa S. (1992) Impaired spatial learning in alpha-calcium-calmodulin kinase II mutant mice. Science 257: 206-211.")
								.<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(pathway, dataSource,
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(new Reference(pathway, dataSource, "Soderling TR. (1999) Ta Ca-calmodulin-dependent protein cascade. Trends Biochem Sci. 24: 232-236.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Tang YP, Shimizu E, Dube GR, Rampon C, Kerchner GA, Zhuo M, Liu G, Tsien JZ. (1999) Genetic enhancement of learning and memory in mice. Nature 401: 63-69.")
								.<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
										...
										.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Toscano CD, Guilarte TR. (2005) Lead neurotoxicity: From exposure to molecular effects. Brain Res Rev. 49: 529-554.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								"Tsien JZ, Huerta PT, Tonegawa S. (1996) The essential role of hippocampal CA1 NMDA receptor-dependent synaptic plasticity in spatial memory. Cell 87: 1327–1338.").<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
				...
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								...
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Wayman GA, Lee YS, Tokomitsu H, Silva A, Soderling TR. (2008) Calmodulin-kinases: modulators of neuronal development and plasticity. Neuron 59: 914-931.")
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource,
								...
								.<Reference> makeItLive());
				pathway.getReferenceIDs().add(new Reference(pathway, dataSource, "Woolf NJ. (1998) A structural basis for memory storage in mammals. Prog Neurobiol. 55: 59-77.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Yang G, Pan F, Gan WB. (2009) Stably maintained dendritic spines are associated with lifelong memories. Nature 462: 920-924.").<Reference> makeItLive());
				pathway.getReferenceIDs().add(
						new Reference(pathway, dataSource, "Yang J, Siao CJ, Nagappan G, Marinic T, Jing D, McGrath K. (2009) Neuronal release of proBDNF. Nat Neurosci. 12: 113-115.").<Reference> makeItLive());
				pathway
						.getReferenceIDs()
						.add(
								new Reference(
