...
//Original source http://www.java.net/external?url=http://www.orbital-computer.de/JComboBox/
...
public class AutoCompletion extends PlainDocument
	{
		...
		public AutoCompletion(final JComboBox comboBox, boolean strictMatching)
			{
				...
				if (strictMatching)
					{
						if (item != null)
						...
						else
							{
								...
								// imitate no insert
								// (later on offs will be incremented by str.length(): selection won't
								// move forward)
						...
						if (item == null)
							{
								...
								nonexisitngItemSelected = true;
							}
						setText(item.toString());
						// select the completed part
						if (!nonexisitngItemSelected)
							highlightCompletedText(offs + str.length());
					}
			}
		...
		private static void createAndShowGUI()
			...
			//		{ "acetoin dehydrogenase", "alcohol dehydrogenase", "alcohol dehydrogenase (NADP+)", "glycerol dehydrogenase", "homoserine dehydrogenase", "(R,R)-butanediol dehydrogenase" });
				
				JComboBox comboBox = new JComboBox();
				comboBox.setEditable(true);

				comboBox.setModel(new OntologyInstanceComboBoxModel(DefaultOntologies.ENZYME,false));
		...
		public boolean isNonexisitngItemSelected()
			{
				return nonexisitngItemSelected;
			}
