...
public class ColumnGroup
	{
		...
		public ColumnGroup(Object object, TableCellRenderer renderer)
			{
				this.object = object;
		...
		public Dimension getSize(JTable table)
			{
				...
				Component comp = renderer.getTableCellRendererComponent(table, getHeaderValue() == null || getHeaderValue().toString().trim().isEmpty() ? " " : getHeaderValue(), false, false, -1, -1);
