...
public class ComponentTableHeaderRenderer implements TableCellRenderer
	{
		...
		public ComponentTableHeaderRenderer(JComponent editor)
			{
				this.editor = editor;
		...
		public void listenForMouseEvents(boolean listen)
			{
				if ((table != null) && (reporter != null))
					{
						final JTableHeader header = table.getTableHeader();
						if (header != null)
							if (listen)
								...
								header.removeMouseListener(reporter);
					}
			}
