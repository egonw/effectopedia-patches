 ...
 */
public class InSilicoModelDataEvidencesUI extends CollapsableTitledPanel implements LoadableEditorUI, SizeOptimizableUI
	{
		
		public InSilicoModelDataEvidencesUI(RootHelpContext rootHelpContext)
			{
					...
					{
							{
								...
								this.evidencesUI.setLayout(thisLayout);
									...
									{
										lrrmuiLocalModel = new LocalRRModelUI(rootHelpContext);
										this.evidencesUI.add(lrrmuiLocalModel);
									}
		...
		public void load(Object o, boolean readonly)
			{
				...
				if (fnRel.getOwner() instanceof Link_EffectToEffect)
					...
					return;
				lrrmuiLocalModel.load(fnRel, readonly);
		...
		public LocalRRModelUI getLocalRRModelUI()
			{
				return lrrmuiLocalModel;
			}
	 ...
	 */
		...
		private LocalRRModelUI																							lrrmuiLocalModel;
