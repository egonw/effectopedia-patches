...
public class DropDownToggleButton extends JToggleButton
	...
	private static final long	serialVersionUID	= 1L;
		...
		public DropDownToggleButton(Icon icon, JPopupMenu popup)
			{
						...
						public void mousePressed(MouseEvent e)
							{
								...
								if (menu != null && getModel() instanceof DropDownToggleButtonModel)
									{
										DropDownToggleButtonModel model = (DropDownToggleButtonModel) getModel();
										if (!model._isPressed())
											{
				...
				setModel(new DropDownToggleButtonModel());
			}
								...
								public void popupMenuWillBecomeInvisible(PopupMenuEvent e)
									{
										...
										if (!mouseInButton)
											{
												if (getModel() instanceof DropDownToggleButtonModel)
													{
														((DropDownToggleButtonModel) getModel())._release();
													}
												JPopupMenu menu = getPopupMenu();
												if (null != menu)
													{
		...
		private Icon updateIcons(Icon orig, String iconType)
			{
				...
				if (null == orig)
				...
				else
					{
						...
						arrow = new ImageIcon((new IconWithArrow(orig, false)).getImage());
		...
		private class DropDownToggleButtonModel extends JToggleButton.ToggleButtonModel
			{
				/**
			 * 
			 */
